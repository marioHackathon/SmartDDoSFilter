...
local sys = os.execute("curl -X PUT -H 'Content-Type: application/json' http://172.16.64.53:5555/policies/l7filter -d '{ policies: [{ \"name\" : \"l7fiter\", \"elements\": [{ \"data\" : \" " ..remote_addr.. " \" }] }] }' ")
